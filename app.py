...
# Prioritize the environment variable, but default to "gcp-key.json" if not set
credentials_path = os.environ.get("GOOGLE_APPLICATION_CREDENTIALS_PATH", "gcp-key.json")
